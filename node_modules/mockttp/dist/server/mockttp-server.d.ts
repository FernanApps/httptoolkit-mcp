import { InitiatedRequest, CompletedRequest, CompletedResponse, TlsHandshakeFailure, ClientError, WebSocketMessage, WebSocketClose, TlsPassthroughEvent, RuleEvent, RawPassthroughEvent, RawPassthroughDataEvent, InitiatedResponse, BodyData } from "../types";
...
export declare class MockttpServer extends AbstractMockttp implements Mockttp {
    ...
    private maxBodySize;
    private keyLogFilePath;
    private keyLogStream;
    private app;
    private server;
    ...
    private announceInitialResponseAsync;
