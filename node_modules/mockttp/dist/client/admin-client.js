...
const util_2 = require("@httptoolkit/util");
...
class ConnectionError extends util_1.CustomError {
}
exports.ConnectionError = ConnectionError;
class RequestError extends util_1.CustomError {
    response;
...
async function requestFromAdminServer(serverUrl, path, options) {
    ...
    try {
        ...
        if ((0, util_2.isErrorLike)(e) && (e.code === 'ECONNREFUSED' ||
...
class AdminClient extends events_1.EventEmitter {
     ...
     * set up and active.
     */
    async tryToReconnectStream(adminSessionBaseUrl, targetStream, retries = this.adminClientOptions.adminStreamReconnectAttempts - 1) {
        ...
        new Promise((resolve, reject) => {
            ...
            if (retries > 0) {
                ...
                await (0, util_2.delay)(Math.min(25 * Math.pow(2, retryAttempt), 2_000));
    ...
    async stop() {
        ...
        this.emit('stopping');
        const stopPromise = (0, util_1.getDeferred)();
