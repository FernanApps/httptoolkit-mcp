...
class AdminServer {
    ...
    app = express();
    server = null;
    eventEmitter = new stream_1.EventEmitter();
    adminPlugins;
    sessions = {};
    constructor(options = {}) {
        ...
        this.app.use((0, milliparsec_1.json)({ payloadLimit: 50 * 1024 * 1024 }));
    ...
    async stop() {
        ...
        await Promise.all(Object.values(this.sessions).map((s) => s.stop()));
        await this.server.destroy();
        this.server = null;
    }
    static baseSchema = (0, graphql_tag_1.default) `
        type Mutation {
            reset: Void
            enableDebug: Void
        }
